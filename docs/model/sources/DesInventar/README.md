...
| [monty:episode_number](https://ifrcgo.org/monty-stac-extension/v1.2.0/schema.json#monty:episode_number)                     | 1                                                  | Set to 1 as Desinventar doesn't track episodes                                          |
| [monty:country_codes](https://ifrcgo.org/monty-stac-extension/v1.2.0/schema.json#monty:country_codes)                       | level0                                             | ISO3 code of the event country                                                          |
| [monty:hazard_codes](https://ifrcgo.org/monty-stac-extension/v1.2.0/schema.json#monty:hazard_codes)                         | [mapped from evento](#hazard-code-mapping)         | Hazard codes mapped from Desinventar event types (see mapping below)                    |
| [monty:corr_id](https://ifrcgo.org/monty-stac-extension/v1.2.0/schema.json#monty:corr_id)                                   | Generated                                          | Generated following the [event correlation](../../correlation_identifier.md) convention |
| [monty:src_event_id](https://ifrcgo.org/monty-stac-extension/v1.2.0/schema.json#monty:src_event_id) | Source event ID | |
...
| [monty:impact_detail](https://ifrcgo.org/monty-stac-extension/v1.2.0/schema.json#monty:impact_detail)                |                            | Object containing impact details                   |
